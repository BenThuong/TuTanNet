...
function tutannet_setup() {
	...
	register_nav_menus( array(
		'primary' => esc_html__( 'Primary', 'tutannet' ),
	) );
	...
	add_theme_support( 'custom-background', apply_filters( 'tutannet_custom_background_args', array(
 ...
 */
function tutannet_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'tutannet_content_width', 640 );
}
add_action( 'after_setup_theme', 'tutannet_content_width', 0 );
...
function tutannet_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'tutannet' ),
		'id'            => 'sidebar-1',
		'description'   => '',
...
function tutannet_scripts() {
	wp_enqueue_style( 'tutannet-style', get_stylesheet_uri() );
	...
	wp_enqueue_script( 'bootstrap-scripts', 'https://maxcdn.bootstrapcdn.com/bootstrap/3.3.6/js/bootstrap.min.js', array('jquery'), '3.3.6' );
